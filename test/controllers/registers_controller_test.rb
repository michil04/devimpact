...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { email: @register.email, expand: @register.expand, first_name: @register.first_name, last_name: @register.last_name, phone_number: @register.phone_number, zip_code: @register.zip_code }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { email: @register.email, expand: @register.expand, first_name: @register.first_name, last_name: @register.last_name, phone_number: @register.phone_number, zip_code: @register.zip_code }
    assert_redirected_to register_path(assigns(:register))
  end
